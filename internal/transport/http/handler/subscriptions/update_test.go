...
func TestHandler_Update_InvalidEndDate(t *testing.T) {
	service := new(mocks.Service)
...
func TestHandler_Update_ContextCanceled(t *testing.T) {
	service := new(mocks.Service)
...
func TestHandler_Update_ContextDeadlineExceeded(t *testing.T) {
	service := new(mocks.Service)
